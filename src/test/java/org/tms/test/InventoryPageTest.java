...
public class InventoryPageTest extends BaseTest {
    ...
    public void addFirstItemToCartTest() {
        ...
        softAssert.assertEquals(actualShoppingCartValue, ONE_ITEM_CART_VALUE, "Shopping cart value not match");
    ...
    public void addAndRemoveFirstItemFromCartTest() {
        ...
        softAssert.assertEquals(actualShoppingCartValue, EMPTY_CART_VALUE, "Shopping cart value not match");
        softAssert.assertAll();
    }
}
